      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-gallery" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name='description' id='input-description'><?php echo $description; ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-show_more">AJAX загрузка</label>
            <div class="col-sm-10">
              <select name="show_more" id="input-show_more" class="form-control">
                <?php if ($show_more) { ?>
